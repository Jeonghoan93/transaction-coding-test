...
We've already pre-imported the minimal React/NextJS boilerplate so please use it as a starting point.
...
### Use the predefined the boilerplate project

For this project we recommend you to use Next.js and React. Therefore we have already set a boilerplate project up with Next.js and styled components in the `/app-frontend` directory. This is where we expect you to do your changes. 
...
Authored by [Alva Labs](https://www.alvalabs.io/), adjusted by Anyfin
